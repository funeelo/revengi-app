...
class _DexRepairScreenState extends State<DexRepairScreen> {
  ...
  Future<void> _repairDexFile() async {
    if ((isWeb() && _dexFileBytes.isEmpty) || (!isWeb() && _dexFile == null)) {
      return;
    }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ListTile(
                      ...
                      subtitle:
                          (_dexFile != null || _dexFileBytes.isNotEmpty)
                              ? Text(_fileName!)
                              : const Text('No file selected'),
                      trailing: ElevatedButton(
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        onPressed:
                            (isWeb()
                                        ? (_dexFileBytes.isEmpty)
                                        : (_dexFile == null)) ||
                                    _isRepairing
                                ? null
                                : _repairDexFile,
                        icon: const Icon(Icons.analytics),
                        label: Text(_isRepairing ? 'Analyzing...' : 'Analyze'),
                      ),
                    ),
                  ],
                ),
